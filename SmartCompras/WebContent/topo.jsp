...
<!-- Container  -->
		...
		<div class="jumbotron">
		  ...
		  <h1>SmartCompras</h1>
		  <p>Uma forma mais prática e eficiente de pesquisar os preços de sua lista de compras sem precisar sair do seu conforto.  
		  Nossa aplicação informa o lugar mais próximo e também o mais barato.</p>
			
			<center><a href="#pular" class="btn btn-primary  btn-block">Saiba mais</a></center>
